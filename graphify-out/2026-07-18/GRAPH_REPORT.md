...
- `CategoriesClient()` --references--> `ALL_CATEGORIES`  [EXTRACTED]
  src/app/cats/CategoriesClient.jsx → src/data/allCategories.js
...
### Community 0 - "react"
Cohesion: 0.06
Nodes (8): react, metadata, metadata, metadata, metadata, fixEncoding(), formatViews(), VideoPlayerClient()
...
Cohesion: 0.12
Nodes (12): allRoutes, categoryRoutes, __dirname, __filename, outputPath, staticRoutes, ALPHABET, CATEGORIES (+4 more)
...
## Knowledge Gaps
- **98 isolated node(s):** `extends`, `next/core-web-vitals`, `$schema`, `oxc`, `react/rules-of-hooks` (+93 more)
...
- **Why does `react` connect `react` to `generate-sitemap.js`, `Oxlint Linting Rules`, `Category Detail Pages`, `Video Card UI Components`, `layout.jsx`, `page.jsx`, `Home Page Client Components`, `Search Result Components`?**
...
- **Should `Cloudflare Deployment Dependencies` be split into smaller, more focused modules?**
  _Cohesion score 0.13333333333333333 - nodes in this community are weakly interconnected._
- **Should `generate-sitemap.js` be split into smaller, more focused modules?**
