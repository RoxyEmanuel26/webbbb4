...
## Corpus Check
- 43 files · ~21,574 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 222 nodes · 210 edges · 40 communities (23 shown, 17 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 5 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c4d3bce2`
...
### Community 0 - "react"
Cohesion: 0.05
Nodes (8): react, metadata, SORT_OPTIONS, metadata, HOT_SEARCHES, fixEncoding(), HomeClient(), SORT_OPTIONS
...
Cohesion: 0.40
Nodes (5): NICEVX Home Page, Eporner API v2, Adsterra Banner Ad Wrapper, Adsterra Advertising Network, Categories Data
...
- **Why does `react` connect `react` to `JavaScript Project Configuration`, `Oxlint Linting Rules`, `Category Detail Pages`, `Video Card UI Components`, `Search Result Components`, `page.jsx`, `page.jsx`, `page.jsx`, `Navbar.jsx`?**
