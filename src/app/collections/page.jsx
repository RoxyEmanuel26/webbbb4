...
export const metadata = {
  ...
  description:
    "Browse focused adult video collections built from verified catalog records and transparent ranking signals.",
...
export default function CollectionsPage() {
  ...
  return (
    <main className="page-wrapper legal-page">
      ...
      <p>
        These discovery hubs are published gradually. A hub becomes indexable
        only after it has at least 12 active videos and a substantial editorial
        introduction.
      </p>
