  ...
  return (
    <div className="page-wrapper legal-page">
      <div className="legal-card">
        ...
        <p>We do not store personal data on our servers. Age verification, saved videos, recent viewing, recommendations, and privacy-first event counters are stored locally in your browser&apos;s localStorage and can be cleared with your browser data. Search terms and personal watch history are not sent to a NICEVX database.</p>
