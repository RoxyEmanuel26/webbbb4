...
const Categories = () => {
  ...
  const handleCatClick = (categoryName) => {
    const formatted = categoryName.toLowerCase().replace(/\s+/g, '-');
    navigate(`/cat/${formatted}`);
  };

  const handleTagClick = (tagName) => {
    const formatted = tagName.toLowerCase().replace(/\s+/g, '-');
