...
const SORT_OPTIONS = [
  ...
  { value: "top-weekly", label: "✨ Recommended" },
...
function sortVideos(videos, order) {
  ...
  if (order === "top-monthly")
    return sorted.sort((a, b) => b.rating - a.rating || b.views - a.views);
  if (order === "top-weekly")
    return sorted.sort((a, b) => b.discoveryScore - a.discoveryScore);
...
export default function HomeClient({
  ...
  const order = SORT_OPTIONS.some((option) => option.value === rawOrder)
    ? rawOrder
    : "latest";
